...
export class AuthEmail {
                ...
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9fafb; border-radius: 8px;">
                    <div style="background-color: #ffffff; padding: 30px; border-radius: 8px; border: 1px solid #e5e7eb;">
                        ...
                        <p style="color: #4b5563; font-size: 16px; line-height: 1.5; margin-bottom: 24px;">
                            Gracias por registrarte en Logify. Para completar el registro de tu cuenta y visita el enlace e ingresa el siguiente código de confirmación:
                        </p>
                        ...
                        <a href="${process.env.FRONTEND_URL}/auth/confirm-account" style="color: #4f46e5; font-size: 16px; line-height: 1.5; margin-bottom: 24px;">
                            Confirmar cuenta
                        </a>
    ...
    static sendPasswordResetToken = async (user: EmailType) => {
        await transport.sendMail({
            from: "Logify <admin@logify.com>",
            to: user.email,
            subject: "Logify - Reestablece tu contraseña",
            text: `Hola ${user.name}, reestablece tu contraseña en Logify ingresando el siguiente código: ${user.token}`,
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9fafb; border-radius: 8px;">
                    <div style="background-color: #ffffff; padding: 30px; border-radius: 8px; border: 1px solid #e5e7eb;">
                        <h1 style="color: #4f46e5; text-align: center; margin-bottom: 24px; font-size: 28px;">Logify</h1>
                        ...
                        <p style="color: #4b5563; font-size: 16px; line-height: 1.5; margin-bottom: 24px;">
                            Has solicitado reestablecer tu contraseña en Logify. Para completar el proceso visita el enlace e ingresa el siguiente código:
                        </p>
                        ...
                        <a href="${process.env.FRONTEND_URL}/auth/new-password" style="color: #4f46e5; font-size: 16px; line-height: 1.5; margin-bottom: 24px;">
                        ...
                        <p style="color: #9ca3af; font-size: 13px; line-height: 1.5; margin-top: 24px; border-top: 1px solid #e5e7eb; padding-top: 16px;">
                            Si tú no solicitaste reestablecer tu constraseña en Logify, puedes ignorar este correo de manera segura.
                        </p>
                    </div>
