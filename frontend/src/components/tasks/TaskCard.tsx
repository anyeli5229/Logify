...
export default function TaskCard({ task, canEdit }: TaskCardProps) {
    ...
    return (
        <li 
            ...
            {...listeners}
            {...attributes}
            className={`p-3.5 bg-white rounded-xl border border-slate-200/80 shadow-xs hover:shadow-md transition-shadow duration-200 group relative flex items-start justify-between gap-2 touch-none select-none ${
                isDragging ? ' z-50 shadow-xl ring-2 ring-indigo-500/50' : ''
            }`}
        >
